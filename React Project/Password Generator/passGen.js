...
// //in this approach every time EventListner triggered, function is called and hecne memory allocated to *all the statements everytime 
        //*setXXX are created only once and there reference is stored
// function Main(){
...
function Main(){
    ...
    const PassGenerate= useCallback(()=>{
            ...
            setPassword(passVal);
        },[count, numberChanged, charChanged]
    )
